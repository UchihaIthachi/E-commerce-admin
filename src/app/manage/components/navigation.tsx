...
function Navigation() {
  return (
    <div className="border-r min-h-screen flex flex-col justify-between">
      <div>
        <h2 className="p-2">Maison Vella</h2>
                  ...
                  <AccordionItem value="attributes">
                    ...
                    <AccordionContent>
                      <div className="flex flex-col gap-y-2">
                        ...
                        <Link
                          href="/manage/group/subcategories"
                          legacyBehavior
                          passHref
                        >
                          <NavigationMenuLink
